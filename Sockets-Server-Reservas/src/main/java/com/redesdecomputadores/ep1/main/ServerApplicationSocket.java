...
import com.redesdecomputadores.ep1.server.ControllerServer;
...
public class ServerApplicationSocket{
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("\n" +
                ...
                " /$$  \\ $$| $$_____/| $$        \\  $$$/ | $$| $$  | $$| $$  | $$| $$      \n" +
                "|  $$$$$$/|  $$$$$$$| $$         \\  $/  | $$|  $$$$$$$|  $$$$$$/| $$      \n" +
                " \\______/  \\_______/|__/          \\_/   |__/ \\_______/ \\______/ |__/      \n" +
                "                                                                          \n" +
                "                                                                          ");
        ...
        while(!server.server_socket.isClosed()) {
            try {
                ...
                ControllerServer new_thread_controller = new ControllerServer(new_client, calendar, tickets_calendar);
                System.out.println(DateTimeLog.get() + "Reservada " + new_thread_controller.getName() + " para cliente: " + new_client.getPort());
                new_thread_controller.start();
            } catch (IOException e) {
